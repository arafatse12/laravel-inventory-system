      ...
      <div class="card-body">
        <form @submit.prevent="signup">
          <div class="form-group">
           ...
           <div class="form-group">
            <div class="form-label-group">
              <input type="date" id="birthday" class="form-control"   autofocus="autofocus" v-model="form.birthday" >
               <small class="text-danger" v-if="errors.birthday"> {{ errors.birthday[0] }} </small>
